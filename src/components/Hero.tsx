        ...
        <div className="flex flex-col items-start">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white font-bold px-8 py-4 rounded-full text-sm uppercase tracking-widest transition-all duration-200 hover:scale-105 active:scale-95"
            >
